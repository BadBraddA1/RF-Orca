...
- **List is the default board view** (Rack available when Rooms or Mic rack assignments is on) — compact one-row cards; grid packs left at fixed card width on wide screens

...
- **List is the default board view** (Rack available when Rooms or Mic rack assignments is on) — ~28–30rem cards; Stage room / Deploy wrap under the name; larger select circles; grid packs left on wide screens

...
- **List is the default board view** (Rack available when Rooms or Mic rack assignments is on) — list cards stay tight (name + MHz + Deploy/Spare + Stage room; no CH label / staged tag / Who)
